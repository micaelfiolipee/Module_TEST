...
def main():
    ...
    poller = MPDPoller()
    poller.connect()
    font_art = ImageFont.truetype('/home/volumio/miniOLED_for_Runeaudio/NanumGothic.ttf', 13)
    font_tit = ImageFont.truetype('/home/volumio/miniOLED_for_Runeaudio/NanumGothic.ttf', 13)
    font_info = ImageFont.truetype('/home/volumio/miniOLED_for_Runeaudio/NanumGothic.ttf', 12)
